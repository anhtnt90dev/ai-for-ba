...
description: "Learning path song ngữ chuyên sâu cho software Business Analyst muốn dùng AI có trách nhiệm, cải thiện artifact BA và đặc tả sản phẩm có AI bằng judgment của chuyên gia."
---
...
<div class="course-card"><strong>AI collaboration và context engineering</strong>Bài học riêng biệt với diagram, artifact, prompt và review control.</div>
<div class="course-card"><strong>Requirements engineering với AI</strong>Bài học riêng biệt với diagram, artifact, prompt và review control.</div>
